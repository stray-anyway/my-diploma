...
class User(AbstractUser):
    ...
    type = models.TextField(choices=UserTypeChoices.choices,
...
class Contact(models.Model):
    ...
    house = models.CharField(max_length=15, verbose_name='Дом', null=True,
                             blank=True)
...
class Order(models.Model):
    ...
    state = models.TextField(choices=OrderStateChoices.choices,
                             verbose_name='Статус')
...
class OrderItem(models.Model):
    ...
    order = models.ForeignKey(Order, related_name='order_items',
                              on_delete=models.CASCADE, null=True, blank=True,
                              verbose_name='Заказ')
    product_info = models.ForeignKey(ProductInfo, related_name='order_items',
                                     on_delete=models.CASCADE, null=True,
                                     blank=True,
                                     verbose_name='Информация о продукте')
    quantity = models.PositiveIntegerField(verbose_name='Количество')
